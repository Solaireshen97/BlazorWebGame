using BlazorWebGame.Rebuild.Hubs;
using BlazorWebGame.Rebuild.Security;
using BlazorWebGame.Rebuild.Middleware;
using BlazorWebGame.Rebuild.Configuration;
...
using BlazorWebGame.Rebuild.Services.Users;
using BlazorWebGame.Rebuild.Services.Reputation;
using BlazorWebGame.Rebuild.Services.Shop;
using BlazorWebGame.Rebuild.Services.Skill;
...
{
    rateLimitOptions.IpRateLimit = new BlazorWebGame.Rebuild.Middleware.RateLimitRule
    {
        MaxRequests = securityConfig.RateLimit.IpRateLimit.MaxRequests,
        TimeWindow = securityConfig.RateLimit.IpRateLimit.TimeWindow
    };

    rateLimitOptions.UserRateLimit = new BlazorWebGame.Rebuild.Middleware.RateLimitRule
    {
...
if (app.Environment.IsDevelopment())
{
    ...
    if (gameServerOptions.EnableDevelopmentTests)
    {
        ...
        try
        {
            BlazorWebGame.Rebuild.Tests.UnifiedEventSystemTest.RunEventSystemTest(app.Services, logger);
            BlazorWebGame.Rebuild.Tests.UnifiedEventSystemTest.RunPerformanceBenchmark(logger);
        }
        catch (Exception ex)
        {
        ...
        try
        {
            await BlazorWebGame.Rebuild.Tests.UserServiceTests.RunBasicTests(logger);
        }
        catch (Exception ex)
        {
        ...
        try
        {
            await BlazorWebGame.Rebuild.Tests.UserCharacterServiceTests.RunComprehensiveTests(logger);
        }
        catch (Exception ex)
        {
