...
/// </summary>
public class EventDrivenBattleEngine : IDisposable
{
...
public class BattleAttackHandler : IUnifiedEventHandler
{
    ...
    public BattleAttackHandler(EventDrivenBattleEngine battleEngine, ILogger logger)
    {
...
public class BattleHealHandler : IUnifiedEventHandler
{
    ...
    public BattleHealHandler(EventDrivenBattleEngine battleEngine, ILogger logger)
    {
        _battleEngine = battleEngine;
        _logger = logger;
    }
...
public class SkillUsageHandler : IUnifiedEventHandler
{
    ...
    public SkillUsageHandler(EventDrivenBattleEngine battleEngine, ILogger logger)
    {
        _battleEngine = battleEngine;
        _logger = logger;
    }
...
public class BattleTickHandler : IUnifiedEventHandler
{
    ...
    public BattleTickHandler(EventDrivenBattleEngine battleEngine, ILogger logger)
    {
        _battleEngine = battleEngine;
        _logger = logger;
    }
